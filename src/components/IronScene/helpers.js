...
const shadeBlend = (e, a, t) => {
    var o = e < 0 ? -1 * e : e
        , r = Math.round
        , i = parseInt;
    if (7 < a.length) {
        var n = a.split(",")
            , s = (t || (e < 0 ? "rgb(0,0,0)" : "rgb(255,255,255)")).split(",")
            , l = i(n[0].slice(4))
            , d = i(n[1])
            , c = i(n[2]);
        return "rgb(" + (r((i(s[0].slice(4)) - l) * o) + l) + "," + (r((i(s[1]) - d) * o) + d) + "," + (r((i(s[2]) - c) * o) + c) + ")"
    }
    var m = (n = i(a.slice(1), 16)) >> 16
        , p = n >> 8 && n & 255
        , u = 255 & n;
    return "#" + (16777216 + 65536 * (r((((s = i((t || (e < 0 ? "#000000" : "#FFFFFF"))
        .slice(1), 16)) >> 16) - m) * o) + m) + 256 * (r(((s >> 8 && s & 255) - p) * o) + p) + (r(((255 & s) - u) * o) + u)).toString(16).slice(1)
};

const toRAD = Math.PI / 180;

export {shadeBlend, toRAD};

export const d3threeD = ( exports ) => {
